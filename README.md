...
| `GOOGLE_SERVICE_ACCOUNT_JSON` | Optional. Full service-account JSON (raw or base64) so auto-saved estimate packs upsert into the owner Drive Estimates room, and Quality/HSE Save folders land under Data / Quality and Data / HSE. |
