...
const COLUMN_ROLES: Array<{ role: Exclude<RateVaultColumnRole, "unknown">; re: RegExp }> = [
  ...
  { role: "fringe", re: /\bfringe\b|\bbenefit\b|\bh\s*&\s*w\b|\bpension\b|\bannuity\b|\bpd\b|\b401k\b/i },
  { role: "burden", re: /\bburden\b|\bmarkup\b|\boh\b|\boverhead\b|\bpay\s*tax\b|\bfica\b|\bins\b|\bw\/c\b|\bprofit\b/i },
