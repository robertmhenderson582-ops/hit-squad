...
export const DESK_VERSION = "1.22.0";
export const DESK_VERSION_LABEL = "Hit Squad Project Controls V1.22";
export const WHATS_NEW_MARK_PREFIX = "hs_whats_new:";
export const DESK_THREAD_ID = "th-desk-v1.22";
export const DESK_PERSON_ID = "desk";

export const TESTER_WHATS_NEW = [
  "Hit Squad Project Controls V1.22",
  "• Turn a job over to another person on the desk so they can finish it.",
  "• Archive or delete a job from your Jobs list. Archive keeps it findable.",
].join("\n");
...
export const OWNER_WHATS_NEW = [
  ...
  "• Turn a job over to another person on the desk so they can finish it.",
  "• Archive or delete a job from your Jobs list. Archive keeps it findable.",
  "• Testers who already saw V1.21 get this note (versioned seen key).",
].join("\n");

/** Draft for the next ship. Not wired into applyWhatsNew — do not publish until Robert says look. */
export const NEXT_SHIP_VERSION = "1.23.0";
export const NEXT_SHIP_VERSION_LABEL = "Hit Squad Project Controls V1.23";
