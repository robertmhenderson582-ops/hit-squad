...
const SITES: SiteRecord[] = [
  ...
  },
  {
    ...
    units: ["U110", "U250"],
    state: "California",
    turnaround: "U110 2026 TA · U250 Fall 2026",
    contract: "Master T&M · Western States / West COMP PCA0001100",
    gate: "Contractor gate",
    notes: "P66 Rodeo. One live pack each for U110 and U250. Dual client templates stay separate. Official Gmail revisions lock filled totals.",
    regularClient: true,
  },
  {
    id: "site-bayway",
  ...
  },
  {
    ...
    contract: "Master T&M",
    gate: "Contractor gate",
    notes: "P66 Ferndale, WA · 3901 Unick Rd. Competitive bid until Madison presence is Regular. Own GEP / TASO client template — not a Rodeo clone.",
    regularClient: false,
  },
  {
    id: "site-madison",
  ...
  },
  {
    ...
    state: "Pennsylvania",
    turnaround: "541V",
    contract: "As bid · Site PLA",
    gate: "Plant security",
    notes: "Monroe Energy Trainer. One live pack for 541V. Official POST REVIEW revision locks filled totals.",
    regularClient: false,
  },
];
