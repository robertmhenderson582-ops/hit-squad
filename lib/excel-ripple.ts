 ...
 * Calendar ST/OT/DT live-tie Job setup ON/Start/Stop/OT (G/H) by phase id. Column span is baked — Start/Stop beyond the exported window needs re-export. Phase bar stays painted (no VBA). Job setup F does not overwrite yellow HPS. CA 7th-day is a re-export gap.
 *
