 ...
 * Craft title-block stays in A–I (instrument only) with Prepared by from the signed-in exporter; phase bar stays on date columns. Import ignores that byline.
 *
