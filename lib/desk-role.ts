...
/** Chance’s Quality seat (and build desk). Does not open Inbox or Suggestion Box. */
export function isQualityVaultSeat(user?: { email?: string; role?: string } | null): boolean {
