      ...
      {shell === "Estimate" ? (
        <section className="plant-card px-5 py-5">
          ...
          <p className="mt-1 text-sm text-[#5b6f73]">
            Staff Day / Night and Craft Day / Night from this job’s hours. Craft weekday 10s = 8+2. 12s = 8+4.
            Saturday is all OT for craft. Sunday DT when that day is on. PT = DT. East Coast still does not
            turn 12s into DT. Mileage Yes is a flat ${MILEAGE_YES_FLAT}, not times headcount. Dollars stay
