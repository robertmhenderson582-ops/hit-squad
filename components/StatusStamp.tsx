const TONE: Record<string, string> = {
  ...
  BUDGETARY: "border-amber-label/60 text-amber-label",
  REVIEW: "border-amber-label/60 text-amber-label",
  LOCKED: "border-amber-flare text-amber-flare",
  SUBMITTED: "border-amber-label/60 text-amber-label",
  AWARDED: "border-steel-glow/50 text-steel-glow",
