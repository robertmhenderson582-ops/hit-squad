const TONE: Record<string, string> = {
  ...
  Estimate: "border-steel-glow/50 text-steel-glow",
  Execute: "border-steel-glow/50 text-steel-glow",
  ...
  Awarded: "border-paper-cream/40 text-paper-cream",
  ...
  Submitted: "border-amber-label/60 text-amber-label",
  "Close out": "border-amber-label/60 text-amber-label",
